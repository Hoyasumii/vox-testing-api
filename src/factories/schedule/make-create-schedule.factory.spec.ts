import { makeCreateScheduleFactory } from "./make-create-schedule.factory";
...
describe("makeCreateScheduleFactory", () => {
	beforeEach(() => {
		jest.clearAllMocks();
	});

	it("deve retornar uma instância de CreateScheduleService", () => {
		// Act
		const service = makeCreateScheduleFactory();
