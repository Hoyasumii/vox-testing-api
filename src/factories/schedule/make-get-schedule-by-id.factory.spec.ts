import { makeGetScheduleByIdFactory } from "./make-get-schedule-by-id.factory";
...
describe("makeGetScheduleByIdFactory", () => {
	beforeEach(() => {
		jest.clearAllMocks();
	});

	it("deve retornar uma instância de GetScheduleByIdService", () => {
		// Act
		const service = makeGetScheduleByIdFactory();
